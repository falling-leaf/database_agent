...
# import evadb  # disabled: evadb import functions commented out (creates hash cache dirs)
...
# def evadb_insert():
#     # DISABLED: creates hash-named cache dirs (e.g. 9bfebd13...)
#     # conn = psycopg2.connect(**db_config)
#     # cur = conn.cursor()
...
#     # DISABLED: creates hash-named cache dirs
#     # evadb_insert()
#     pass
...
if __name__ == "__main__":
    morphing_insert()
    # evadb_insert()  # DISABLED: creates hash cache dirs
